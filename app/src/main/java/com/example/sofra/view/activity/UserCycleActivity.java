...
public class UserCycleActivity extends BaseActivity {
    ...
    @BindView(R.id.user_cycle_activity_btn_no_connection)
    Button userCycleActivityBtnNoConnection;
    ...
    private void internetConnection() {
        if (haveNetworkConnection()) {
            ...
            userCycleActivityBtnNoConnection.setOnClickListener(new View.OnClickListener() {
                @Override
