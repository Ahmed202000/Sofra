...
public class UserItemDetailsFragment extends BaseFragment {
    ...
    public ListRestaurantItemData restaurantItem;
    ...
    private void getItemDetailsData() {
        ...
        if (restaurantItem.getHasOffer() == true) {
    ...
    public void increment() {
        if (quantity < 100) {
            ...
            Toast.makeText(getActivity(), "can't order above 100 cup ", Toast.LENGTH_SHORT).show();
        }
